...
class NodeDriverServiceProvider extends service_provider_core_1.ServiceProviderCore {
    ...
    constructor(mongoClient, bus, clientOptions, uri, lastSeenTopology) {
        ...
        this.mongoClient.on?.('topologyDescriptionChanged', (evt) => {
    ...
    async getNewConnection(uri, options = {}) {
        ...
        clientOptions.parentState = state;
        return new NodeDriverServiceProvider(client, this.bus, clientOptions, connectionString, lastSeenTopology ?? this._lastSeenTopology);
    }
    ...
    async getConnectionInfo() {
        ...
        return {
            ...
            extraInfo: {
                ...
                has_csfle_schema: !!(autoEncryption?.schemaMap || autoEncryption?.encryptedFieldsMap),
            },
        };
    }
